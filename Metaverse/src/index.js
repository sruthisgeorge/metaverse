...
const material_space = new THREE.MeshPhongMaterial( {color: 0x00cc00} );
...
// Geometric position to be represented in the Metaverse :Cube
const geometry = new THREE.BoxGeometry(5,5,5,5 );
const material = new THREE.MeshPhongMaterial( { color: 0x801a00 } );
const cube = new THREE.Mesh( geometry, material );
scene.add( cube );

// Geometric position to be represented in the Metaverse : Cone
...
// Geometric position to be represented in the Metaverse :Cylinder
...
// Geometric position to be represented in the Metaverse : capsule
const geometry_capsule = new THREE.CapsuleGeometry( 1, 1, 4, 8 );
const material_capsule = new THREE.MeshPhongMaterial( {color: 0x4d004d} );
const capsule = new THREE.Mesh( geometry_capsule, material_capsule );
capsule.position.set( 35 ,5, 0);
scene.add( capsule );
...
function mintNFT() {
    ...
    let contract = new web3.eth.Contract(abi, "0x5bc85794f675B107cd0a60B9934659D482e485fA");
